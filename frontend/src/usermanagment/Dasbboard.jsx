      ...
      <div className="flex-1 overflow-hidden">
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-800">Field Management</h3>
                <p className="text-xs text-gray-600">Quick overview of your fields</p>
              </div>
              <button className="bg-[#34A853] hover:bg-[#22C55E] text-white px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">
                View All Fields
              </button>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              <div className="bg-[#34A853]/10 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-[#34A853]">4</div>
                <div className="text-xs text-gray-600">Total Fields</div>
              </div>
              <div className="bg-[#60A5FA]/10 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-[#60A5FA]">19.6</div>
                <div className="text-xs text-gray-600">Total Acres</div>
              </div>
              <div className="bg-[#FACC15]/10 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-[#FACC15]">3</div>
                <div className="text-xs text-gray-600">Active Crops</div>
              </div>
              <div className="bg-[#F97316]/10 rounded-lg p-3 text-center">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="bg-gradient-to-r from-[#34A853]/10 to-[#22C55E]/10 border border-[#34A853]/20 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-gray-800 text-sm">North Field</h4>
                  <span className="bg-[#34A853] text-white text-xs px-1.5 py-0.5 rounded-full">Active</span>
                </div>
                <div className="text-xs text-gray-600">Wheat • 5.2 acres • Growing</div>
              </div>
              <div className="bg-gradient-to-r from-[#F97316]/10 to-[#EA580C]/10 border border-[#F97316]/20 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-gray-800 text-sm">South Field</h4>
                  <span className="bg-[#F97316] text-white text-xs px-1.5 py-0.5 rounded-full">Alert</span>
                </div>
                <div className="text-xs text-gray-600">Corn • 3.8 acres • Needs Irrigation</div>
              </div>
            </div>
          </div>
        </div>
